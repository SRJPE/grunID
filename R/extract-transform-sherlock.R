...
#' @param layout_type either `split_plate_early_late`, `split_plate_spring_winter`, or `triplicate`.
...
#' @export
#' @md
process_well_sample_details <- function(filepath, sample_type, layout_type, plate_run_id) {
  ...
  # triplicate
  if(str_detect(layout_type, "triplicate")) {
