...
#' @param assay_type either `Ots28_Early1`, `Ots28_Late1`, `Ots16_Spring1`, or `Ots16_Winter1`.
#' This is set here.
...
#' by the Synergy H1 reader to sample identifiers in the database.
...
process_well_sample_details <- function(filepath, sample_type, assay_type, plate_run_id) {
  ...
  assay_id <- case_when(assay_type == "Ots28_Early1" ~ 1,
                        assay_type == "Ots28_Late1" ~ 2,
                        assay_type == "Ots16_Spring1" ~ 3,
                        assay_type == "Ots16_Winter1" ~ 4)
