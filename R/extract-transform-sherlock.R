...
#' @param layout_type either `split_plate_early_late`, `split_plate_late_early`, `split_plate_spring_winter`,
#' `split_plate_winter_spring`, `triplicate`,
...
process_well_sample_details <- function(filepath,
  ...
  if(layout_type %in% c("split_plate_early_late", "split_plate_late_early",
    ...
    assay_ids <- dplyr::case_when(layout_type == "split_plate_early_late" ~ c(1, 2),
                                  layout_type == "split_plate_late_early" ~ c(2, 1),
                                  layout_type == "split_plate_spring_winter" ~ c(3, 4),
                                  layout_type == "split_plate_winter_spring" ~ c(4, 3))
