...
The first step in the process is to confirm that your account has been successfully linked to Azure. To do this, navigate to the [Microsoft Azure Portal](https://portal.azure.com/) and log in with your existing credentials or create a new account. Once logged in, click on your account as shown below.
