sample_locations <- structure(list(
  id = 1:10,
  code = c("BTC", "BUT", "CLR", "DER",
           "FTH_RM17", "MIL", "DEL", "KNL", "TIS", "FTH_RM61"),
  location_name = c("Battle",
                    "Butte", "Clear", "Deer", "Feather-RM17", "Mill", "Sac-Delta Entry",
                    "Sac-KNL", "Sac-Tisdale", "Feather-RM61"),
  stream_name = c("Battle Creek",
                  "Butte Creek", "Clear Creek", "Deer Creek", "Feather River",
                  "Mill Creek", "Sacramento River", "Sacramento River", "Sacramento River",
                  "Feather River"),
  description = c("Upper Battle Creek (RM 6.2 above CNFH barrier weir)",
  ...
  managing_agency_id = c(3L,
                         2L, 3L, 2L, 1L, 2L, 2L, 2L, 2L, 1L),
  latitude = c(38.5471828481241,
               ...
               38.5579224896337),
  longitude = c(-121.699675015962, -121.712721280568,
  ...
  created_by = c("postgres",
                 "postgres", "postgres", "postgres", "postgres", "postgres",
                 "postgres", "postgres", "postgres", "postgres"),
  updated_at = structure(c(1655487861.31747,
                           1655487861.31747, 1655487861.31747, 1655487861.31747, 1655487861.31747,
                           1655487861.31747, 1655487861.31747, 1655487861.31747, 1655487861.31747,
